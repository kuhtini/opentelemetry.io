<img width="974" height="265" alt="image" src="https://github.com/user-attachments/assets/6a96c67e-dc58-454b-8155-d0897022d9b4" />---
...
| `otel.exporter.otlp.protocol`                              | The transport protocol to use on OTLP trace, metric, and log requests. Options include `grpc` and `http/protobuf`.                                                                                                                                                                                                                                                                                                                   | `http/protobuf` **[1]**                                                                                                             |
| `otel.exporter.otlp.{signal}.protocol`                     | The transport protocol to use on OTLP {signal} requests. Options include `grpc` and `http/protobuf`.                                                                                                                                                                                                                                                                                                                                 | `http/protobuf` **[1]**                                                                                                             |
...
**[1]**: OpenTelemetry Java agent 1.x uses `grpc` by default.
